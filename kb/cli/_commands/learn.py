"""``knowledgebase-cli learn`` — the learnability affordance.
...
_TEXT = """\
knowledgebase-cli — a clonable template for AgentCulture mesh agents.
...
Commands
--------
  knowledgebase-cli whoami             Identity from culture.yaml.
  knowledgebase-cli learn              This self-teaching prompt.
  knowledgebase-cli explain <path>...  Markdown docs for any noun/verb path.
  knowledgebase-cli overview           Descriptive snapshot of the agent.
  knowledgebase-cli doctor             Check the agent-identity invariants.
  knowledgebase-cli cli overview       Describe the CLI surface itself.
...
def _as_json_payload() -> dict[str, object]:
    return {
        ...
        "json_support": True,
        "explain_pointer": "knowledgebase-cli explain <path>",
    }
