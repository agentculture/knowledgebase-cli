...
Every failure inside knowledgebase-cli raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`kb.cli._output`,
...
# Exit-code policy. Documented in ``knowledgebase-cli learn`` output.
# 0      = success
