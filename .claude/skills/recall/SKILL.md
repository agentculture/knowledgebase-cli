...
description: >
  ...
  defaults queries to this agent's PERSONAL, PRIVATE scope (`--scope knowledgebase-cli
...
- `--scope NAME` / `--visibility public|private` — scope isolation (no private
  ...
  (`--scope knowledgebase-cli --visibility private`, suffix read from `culture.yaml`),
