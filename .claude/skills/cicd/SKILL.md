...
type: command
description: >
  knowledgebase-cli's CI/CD lane, layered on `devex pr`. Delegates lint / open /
  ...
  unresolved threads). Use when: creating PRs in knowledgebase-cli, handling
...
# CI/CD — knowledgebase-cli edition
